...
"""_special_asset_sig is a randomly assigned hash used to identify assets in maps.  See pkg/resource/asset.go."""

_special_archive_sig = "0def7320c3a5731c473e5ecbe6d01bc7"
"""_special_archive_sig is a randomly assigned hash used to identify assets in maps.  See pkg/resource/asset.go."""

_special_secret_sig = "1b47061264138c4ac30d75fd1eb44270"
"""_special_secret_sig is a randomly assigned hash used to identify secrets in maps.  See pkg/resource/properties.go."""
...
def deserialize_properties(props_struct: struct_pb2.Struct) -> Any:
    ...
    if _special_sig_key in props_struct:
        if props_struct[_special_sig_key] == _special_asset_sig:
            ...
            if "value" in props_struct:
                # TODO [pulumi/pulumi#397]: retain these as first-class secrets
                return deserialize_property(props_struct["value"])
