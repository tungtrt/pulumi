...
_READRESOURCEREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='enableSecrets', full_name='pulumirpc.ReadResourceRequest.enableSecrets', index=7,
...
_REGISTERRESOURCEREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='enableSecrets', full_name='pulumirpc.RegisterResourceRequest.enableSecrets', index=8,
