...
proto.pulumirpc.SupportsFeatureResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    hassupport: jspb.Message.getFieldWithDefault(msg, 1, false)
  };
 ...
 * @const
 */
proto.pulumirpc.RegisterResourceRequest.repeatedFields_ = [7,13];
...
proto.pulumirpc.RegisterResourceRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    acceptsecrets: jspb.Message.getFieldWithDefault(msg, 12, false),
    secretoutputsList: jspb.Message.getRepeatedField(msg, 13)
  };
...
/**
 * optional bool acceptSecrets = 12;
 * Note that Boolean fields may be set to 0/1 when serialized from a Java server.
 * You should avoid comparisons like {@code val === true/false} in those cases.
 * @return {boolean}
 */
...
/**
 * repeated string secretOutputs = 13;
 * @return {!Array.<string>}
 */
