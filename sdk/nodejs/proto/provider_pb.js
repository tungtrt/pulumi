...
proto.pulumirpc.ConfigureRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    enablesecrets: jspb.Message.getFieldWithDefault(msg, 2, false)
  };
...
/**
 * optional bool enableSecrets = 2;
 * Note that Boolean fields may be set to 0/1 when serialized from a Java server.
 * You should avoid comparisons like {@code val === true/false} in those cases.
 * @return {boolean}
 */
proto.pulumirpc.ConfigureRequest.prototype.getEnablesecrets = function() {
  return /** @type {boolean} */ (jspb.Message.getFieldWithDefault(this, 2, false));
};


/** @param {boolean} value */
proto.pulumirpc.ConfigureRequest.prototype.setEnablesecrets = function(value) {
...
proto.pulumirpc.ConfigureResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    enablesecrets: jspb.Message.getFieldWithDefault(msg, 1, false)
  };
...
/**
 * optional bool enableSecrets = 1;
 * Note that Boolean fields may be set to 0/1 when serialized from a Java server.
 * You should avoid comparisons like {@code val === true/false} in those cases.
 * @return {boolean}
 */
proto.pulumirpc.ConfigureResponse.prototype.getEnablesecrets = function() {
  return /** @type {boolean} */ (jspb.Message.getFieldWithDefault(this, 1, false));
};


/** @param {boolean} value */
proto.pulumirpc.ConfigureResponse.prototype.setEnablesecrets = function(value) {
...
proto.pulumirpc.InvokeRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    enablesecrets: jspb.Message.getFieldWithDefault(msg, 4, false)
  };
...
/**
 * optional bool enableSecrets = 4;
 * Note that Boolean fields may be set to 0/1 when serialized from a Java server.
 * You should avoid comparisons like {@code val === true/false} in those cases.
 * @return {boolean}
 */
proto.pulumirpc.InvokeRequest.prototype.getEnablesecrets = function() {
  return /** @type {boolean} */ (jspb.Message.getFieldWithDefault(this, 4, false));
};


/** @param {boolean} value */
proto.pulumirpc.InvokeRequest.prototype.setEnablesecrets = function(value) {
