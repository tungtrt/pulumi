...
proto.pulumirpc.RunRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    enablesecrets: jspb.Message.getFieldWithDefault(msg, 10, false)
  };
...
/**
 * optional bool enableSecrets = 10;
 * Note that Boolean fields may be set to 0/1 when serialized from a Java server.
 * You should avoid comparisons like {@code val === true/false} in those cases.
 * @return {boolean}
 */
proto.pulumirpc.RunRequest.prototype.getEnablesecrets = function() {
  return /** @type {boolean} */ (jspb.Message.getFieldWithDefault(this, 10, false));
};


/** @param {boolean} value */
proto.pulumirpc.RunRequest.prototype.setEnablesecrets = function(value) {
