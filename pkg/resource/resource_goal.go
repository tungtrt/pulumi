...
type Goal struct {
	...
	SecretOutputs        []PropertyKey         // outputs that should always be treated as secrets.
}
...
func NewGoal(t tokens.Type, name tokens.QName, custom bool, props PropertyMap,
	...
	propertyDependencies map[PropertyKey][]URN, deleteBeforeReplace bool, secretOutputs []PropertyKey) *Goal {
